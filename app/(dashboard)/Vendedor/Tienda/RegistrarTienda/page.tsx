...
const steps: StepData[] = [
  {
    ...
    description:
      "Ingrese la información solicitada, no puede faltar ningún campo",
  },
  {
...
function CircularProgressWithLabel(
  ...
  return (
    <Box
      sx={{ position: "relative", display: "inline-flex", marginTop: "20px" }}
    >
                          ...
                          >
                            ...
                            <div className="inputs" style={{ marginTop: 30 }}>
                              <AutocompleteGlobal
                                ...
                                options={top100Films}
                                renderInput={(params) => (
                                  <TextField {...params} label="Municipios" />
                                )}
                              />
                            </div>
                          </Box>
